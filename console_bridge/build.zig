...
pub fn buildWithArgs(b: *std.Build, args: zigros.CompileArgs) *Step.Compile {
    ...
    // This is so annoying - the CMake-generated header cv_bridge_export.h does practically nothing...
    console_bridge.addIncludePath(b.path("console_bridge/include"));
    ...
    console_bridge_lib.installHeader(b.path("console_bridge/include/console_bridge_export.h"), "console_bridge_export.h");
