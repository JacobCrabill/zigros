...
RUN cd zigros-main; /zig-linux-x86_64-0.14.0/zig build -Doptimize=ReleaseFast -Dtarget=x86_64-linux-gnu -Dlinkage=dynamic --summary none
...
RUN cd rclcpp_example-main; /zig-linux-x86_64-0.14.0/zig build -Doptimize=ReleaseFast -Dlinkage=dynamic -Dtarget=x86_64-linux-gnu --summary none
